...
STAGE2_LEARNING_RATE="${STAGE2_LEARNING_RATE:-4.5e-7}"
WEIGHT_DECAY="${WEIGHT_DECAY:-0.01}"
MAX_GRAD_NORM="${MAX_GRAD_NORM:-1.0}"
MARGIN_MIN="${MARGIN_MIN:-0.34}"
...
LOSS_PAIR_WEIGHT="${LOSS_PAIR_WEIGHT:-0.24}"
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.22}"
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-0.85}"
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-0.65}"
DOMAIN_PAIR_LOSS_SCALE="${DOMAIN_PAIR_LOSS_SCALE:-1.0}"
METHOD_PAIR_LOSS_SCALE="${METHOD_PAIR_LOSS_SCALE:-1.20}"
DOMAIN_LIST_LOSS_SCALE="${DOMAIN_LIST_LOSS_SCALE:-1.0}"
METHOD_LIST_LOSS_SCALE="${METHOD_LIST_LOSS_SCALE:-0.90}"
...
PAIR_MID_MARGIN_MIN="${PAIR_MID_MARGIN_MIN:-0.06}"
PAIR_MID_MARGIN_MAX="${PAIR_MID_MARGIN_MAX:-0.36}"
PAIR_MID_ADD_EASY_CONTRAST="${PAIR_MID_ADD_EASY_CONTRAST:-true}"  # true | false
PAIR_TYPE_WEIGHT_MAP="${PAIR_TYPE_WEIGHT_MAP:-default=1.0,llm_disagreement=1.25,strong_vs_boundary=1.12,strong_vs_weak=0.95,strong_vs_hard=1.0}"
...
CLUSTER_MARGIN_HM="${CLUSTER_MARGIN_HM:-0.24}"
CLUSTER_MARGIN_ML="${CLUSTER_MARGIN_ML:-0.24}"
CLUSTER_MARGIN_HL="${CLUSTER_MARGIN_HL:-0.55}"
...
CALIB_LOW_CEIL="${CALIB_LOW_CEIL:-0.08}"
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.2}"
...
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-2.8}"
STAGE2_OOB_LOW_WEIGHT="${STAGE2_OOB_LOW_WEIGHT:-3.3}"
...
log "Starting ce/train2.py (domain+method)"
