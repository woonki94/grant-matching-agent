...
LOSS_KL_WEIGHT="${LOSS_KL_WEIGHT:-0.66}"
LOSS_PAIR_WEIGHT="${LOSS_PAIR_WEIGHT:-0.14}"
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.26}"
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-0.65}"
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-0.70}"
DOMAIN_PAIR_LOSS_SCALE="${DOMAIN_PAIR_LOSS_SCALE:-1.0}"
METHOD_PAIR_LOSS_SCALE="${METHOD_PAIR_LOSS_SCALE:-0.95}"
DOMAIN_LIST_LOSS_SCALE="${DOMAIN_LIST_LOSS_SCALE:-1.12}"
METHOD_LIST_LOSS_SCALE="${METHOD_LIST_LOSS_SCALE:-1.30}"
...
CALIB_HIGH_FLOOR="${CALIB_HIGH_FLOOR:-0.81}"
CALIB_MID_CENTER="${CALIB_MID_CENTER:-0.45}"
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.16}"
CALIB_LOW_CEIL="${CALIB_LOW_CEIL:-0.09}"
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-2.4}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-2.1}"
LOSS_CALIBRATION_LOW_WEIGHT="${LOSS_CALIBRATION_LOW_WEIGHT:-1.5}"
STAGE2_OOB_SELECTION_SPLIT="${STAGE2_OOB_SELECTION_SPLIT:-val}"  # val | test
STAGE2_OOB_HIGH_WEIGHT="${STAGE2_OOB_HIGH_WEIGHT:-3.3}"
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-3.4}"
STAGE2_OOB_LOW_WEIGHT="${STAGE2_OOB_LOW_WEIGHT:-2.3}"
