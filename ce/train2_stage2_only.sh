...
LOSS_CALIBRATION_MID_LOW_WEIGHT="${LOSS_CALIBRATION_MID_LOW_WEIGHT:-0.55}"
...
STAGE2_OOB_MID_LOW_WEIGHT="${STAGE2_OOB_MID_LOW_WEIGHT:-4.2}"
STAGE2_OOB_MID_HIGH_WEIGHT="${STAGE2_OOB_MID_HIGH_WEIGHT:-9.0}"
