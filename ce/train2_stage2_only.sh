...
STAGE2_EPOCHS="${STAGE2_EPOCHS:-18}"
...
STAGE2_EARLY_STOP_PATIENCE="${STAGE2_EARLY_STOP_PATIENCE:-7}"
...
LOSS_KL_WEIGHT="${LOSS_KL_WEIGHT:-0.46}"
LOSS_PAIR_WEIGHT="${LOSS_PAIR_WEIGHT:-0.10}"
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.54}"
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-0.38}"
...
DOMAIN_LIST_LOSS_SCALE="${DOMAIN_LIST_LOSS_SCALE:-1.10}"
METHOD_LIST_LOSS_SCALE="${METHOD_LIST_LOSS_SCALE:-1.08}"
CONSTRAINT_LIST_LOSS_SCALE="${CONSTRAINT_LIST_LOSS_SCALE:-1.15}"
DOMAIN_CALIBRATION_HIGH_SCALE="${DOMAIN_CALIBRATION_HIGH_SCALE:-1.35}"
DOMAIN_CALIBRATION_MID_SCALE="${DOMAIN_CALIBRATION_MID_SCALE:-1.90}"
DOMAIN_CALIBRATION_LOW_SCALE="${DOMAIN_CALIBRATION_LOW_SCALE:-1.35}"
METHOD_CALIBRATION_HIGH_SCALE="${METHOD_CALIBRATION_HIGH_SCALE:-0.95}"
METHOD_CALIBRATION_MID_SCALE="${METHOD_CALIBRATION_MID_SCALE:-2.45}"
METHOD_CALIBRATION_LOW_SCALE="${METHOD_CALIBRATION_LOW_SCALE:-1.90}"
CONSTRAINT_CALIBRATION_HIGH_SCALE="${CONSTRAINT_CALIBRATION_HIGH_SCALE:-0.75}"
CONSTRAINT_CALIBRATION_MID_SCALE="${CONSTRAINT_CALIBRATION_MID_SCALE:-3.35}"
CONSTRAINT_CALIBRATION_LOW_SCALE="${CONSTRAINT_CALIBRATION_LOW_SCALE:-4.25}"
...
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.55}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-3.50}"
LOSS_CALIBRATION_LOW_WEIGHT="${LOSS_CALIBRATION_LOW_WEIGHT:-4.25}"
...
WANDB_TAGS="${WANDB_TAGS:-ce,domain,method,constraint,stage2-only,oob-calibration}"
