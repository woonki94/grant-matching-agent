...
MODEL_ID="${MODEL_ID:-/nfs/stak/users/kimwoon/hpc-share/grant-matching-agent/ce/models/bge_reranker_distill__sd42_s14_s24_bs2_ga16_cp32_ml8_lr5em07_lr11em06_lr25em07_t1p2_kl0p5_pw0p2_mse0p15_cm1_cb0p3/stage1_epoch_1}"
...
STAGE2_LEARNING_RATE="${STAGE2_LEARNING_RATE:-3.5e-7}"
...
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.42}"
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-1.20}"
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-1.10}"
CLUSTER_MARGIN_HM="${CLUSTER_MARGIN_HM:-0.28}"
CLUSTER_MARGIN_ML="${CLUSTER_MARGIN_ML:-0.30}"
CLUSTER_MARGIN_HL="${CLUSTER_MARGIN_HL:-0.62}"
...
CALIB_MID_CENTER="${CALIB_MID_CENTER:-0.36}"
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.08}"
CALIB_LOW_CEIL="${CALIB_LOW_CEIL:-0.06}"
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.6}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-2.0}"
LOSS_CALIBRATION_LOW_WEIGHT="${LOSS_CALIBRATION_LOW_WEIGHT:-2.2}"
STAGE2_OOB_SELECTION_SPLIT="${STAGE2_OOB_SELECTION_SPLIT:-val}"  # val | test
STAGE2_OOB_HIGH_WEIGHT="${STAGE2_OOB_HIGH_WEIGHT:-2.5}"
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-4.0}"
STAGE2_OOB_LOW_WEIGHT="${STAGE2_OOB_LOW_WEIGHT:-4.5}"
...
STAGE2_GATED_MRR_MIN="${STAGE2_GATED_MRR_MIN:-0.68}"
