...
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.32}"
...
DOMAIN_LIST_LOSS_SCALE="${DOMAIN_LIST_LOSS_SCALE:-1.25}"
METHOD_LIST_LOSS_SCALE="${METHOD_LIST_LOSS_SCALE:-1.15}"
DOMAIN_CALIBRATION_HIGH_SCALE="${DOMAIN_CALIBRATION_HIGH_SCALE:-1.65}"
DOMAIN_CALIBRATION_MID_SCALE="${DOMAIN_CALIBRATION_MID_SCALE:-1.85}"
DOMAIN_CALIBRATION_LOW_SCALE="${DOMAIN_CALIBRATION_LOW_SCALE:-1.00}"
METHOD_CALIBRATION_HIGH_SCALE="${METHOD_CALIBRATION_HIGH_SCALE:-1.85}"
METHOD_CALIBRATION_MID_SCALE="${METHOD_CALIBRATION_MID_SCALE:-1.20}"
METHOD_CALIBRATION_LOW_SCALE="${METHOD_CALIBRATION_LOW_SCALE:-1.00}"
