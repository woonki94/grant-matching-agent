...
DOMAIN_CALIBRATION_HIGH_SCALE="${DOMAIN_CALIBRATION_HIGH_SCALE:-1.25}"
DOMAIN_CALIBRATION_MID_SCALE="${DOMAIN_CALIBRATION_MID_SCALE:-2.35}"
...
METHOD_CALIBRATION_MID_SCALE="${METHOD_CALIBRATION_MID_SCALE:-3.45}"
...
CONSTRAINT_CALIBRATION_MID_SCALE="${CONSTRAINT_CALIBRATION_MID_SCALE:-4.15}"
CONSTRAINT_CALIBRATION_LOW_SCALE="${CONSTRAINT_CALIBRATION_LOW_SCALE:-4.10}"
...
CALIB_MID_CENTER="${CALIB_MID_CENTER:-0.39}"
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.12}"
CALIB_LOW_CEIL="${CALIB_LOW_CEIL:-0.050}"
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.55}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-4.35}"
LOSS_CALIBRATION_LOW_WEIGHT="${LOSS_CALIBRATION_LOW_WEIGHT:-3.80}"
STAGE2_OOB_SELECTION_SPLIT="${STAGE2_OOB_SELECTION_SPLIT:-val}"  # val | test
STAGE2_OOB_HIGH_WEIGHT="${STAGE2_OOB_HIGH_WEIGHT:-3.0}"
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-7.4}"
STAGE2_OOB_LOW_WEIGHT="${STAGE2_OOB_LOW_WEIGHT:-4.8}"
