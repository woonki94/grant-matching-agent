...
STAGE2_EPOCHS="${STAGE2_EPOCHS:-22}"
...
STAGE2_EARLY_STOP_PATIENCE="${STAGE2_EARLY_STOP_PATIENCE:-8}"
...
STAGE2_LEARNING_RATE="${STAGE2_LEARNING_RATE:-2.8e-7}"
...
LOSS_PAIR_WEIGHT="${LOSS_PAIR_WEIGHT:-0.10}"
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.66}"
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-0.34}"
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-1.30}"
...
DOMAIN_LIST_LOSS_SCALE="${DOMAIN_LIST_LOSS_SCALE:-1.05}"
METHOD_LIST_LOSS_SCALE="${METHOD_LIST_LOSS_SCALE:-1.00}"
CONSTRAINT_LIST_LOSS_SCALE="${CONSTRAINT_LIST_LOSS_SCALE:-1.08}"
DOMAIN_CALIBRATION_HIGH_SCALE="${DOMAIN_CALIBRATION_HIGH_SCALE:-1.45}"
DOMAIN_CALIBRATION_MID_SCALE="${DOMAIN_CALIBRATION_MID_SCALE:-1.85}"
DOMAIN_CALIBRATION_LOW_SCALE="${DOMAIN_CALIBRATION_LOW_SCALE:-1.20}"
METHOD_CALIBRATION_HIGH_SCALE="${METHOD_CALIBRATION_HIGH_SCALE:-0.80}"
METHOD_CALIBRATION_MID_SCALE="${METHOD_CALIBRATION_MID_SCALE:-2.85}"
METHOD_CALIBRATION_LOW_SCALE="${METHOD_CALIBRATION_LOW_SCALE:-1.70}"
CONSTRAINT_CALIBRATION_HIGH_SCALE="${CONSTRAINT_CALIBRATION_HIGH_SCALE:-0.65}"
CONSTRAINT_CALIBRATION_MID_SCALE="${CONSTRAINT_CALIBRATION_MID_SCALE:-3.70}"
CONSTRAINT_CALIBRATION_LOW_SCALE="${CONSTRAINT_CALIBRATION_LOW_SCALE:-4.35}"
...
CLUSTER_MARGIN_HL="${CLUSTER_MARGIN_HL:-0.44}"
...
CALIB_HIGH_FLOOR="${CALIB_HIGH_FLOOR:-0.76}"
CALIB_MID_CENTER="${CALIB_MID_CENTER:-0.42}"
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.13}"
DOMAIN_CALIB_MID_CENTER="${DOMAIN_CALIB_MID_CENTER:-0.50}"
DOMAIN_CALIB_MID_BANDWIDTH="${DOMAIN_CALIB_MID_BANDWIDTH:-0.17}"
METHOD_CALIB_MID_CENTER="${METHOD_CALIB_MID_CENTER:-0.40}"
METHOD_CALIB_MID_BANDWIDTH="${METHOD_CALIB_MID_BANDWIDTH:-0.14}"
CONSTRAINT_CALIB_MID_CENTER="${CONSTRAINT_CALIB_MID_CENTER:-0.40}"
CONSTRAINT_CALIB_MID_BANDWIDTH="${CONSTRAINT_CALIB_MID_BANDWIDTH:-0.16}"
CALIB_LOW_CEIL="${CALIB_LOW_CEIL:-0.045}"
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.45}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-3.85}"
LOSS_CALIBRATION_MID_LOW_WEIGHT="${LOSS_CALIBRATION_MID_LOW_WEIGHT:-1.00}"
LOSS_CALIBRATION_MID_HIGH_WEIGHT="${LOSS_CALIBRATION_MID_HIGH_WEIGHT:-1.75}"
LOSS_CALIBRATION_LOW_WEIGHT="${LOSS_CALIBRATION_LOW_WEIGHT:-4.10}"
STAGE2_OOB_SELECTION_SPLIT="${STAGE2_OOB_SELECTION_SPLIT:-val}"  # val | test
STAGE2_OOB_HIGH_WEIGHT="${STAGE2_OOB_HIGH_WEIGHT:-3.2}"
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-6.2}"
STAGE2_OOB_MID_LOW_WEIGHT="${STAGE2_OOB_MID_LOW_WEIGHT:-6.0}"
STAGE2_OOB_MID_HIGH_WEIGHT="${STAGE2_OOB_MID_HIGH_WEIGHT:-8.0}"
STAGE2_OOB_LOW_WEIGHT="${STAGE2_OOB_LOW_WEIGHT:-5.4}"
...
WANDB_TAGS="${WANDB_TAGS:-ce,domain,method,constraint,stage2-only,oob-calibration,asymmetric-mid-oob}"
...
CMD=(
  ...
  --loss-calibration-mid-low-weight "${LOSS_CALIBRATION_MID_LOW_WEIGHT}"
  --loss-calibration-mid-high-weight "${LOSS_CALIBRATION_MID_HIGH_WEIGHT}"
  ...
  --domain-calib-mid-center "${DOMAIN_CALIB_MID_CENTER}"
  --domain-calib-mid-bandwidth "${DOMAIN_CALIB_MID_BANDWIDTH}"
  --method-calib-mid-center "${METHOD_CALIB_MID_CENTER}"
  --method-calib-mid-bandwidth "${METHOD_CALIB_MID_BANDWIDTH}"
  --constraint-calib-mid-center "${CONSTRAINT_CALIB_MID_CENTER}"
  --constraint-calib-mid-bandwidth "${CONSTRAINT_CALIB_MID_BANDWIDTH}"
  ...
  --stage2-oob-mid-low-weight "${STAGE2_OOB_MID_LOW_WEIGHT}"
  --stage2-oob-mid-high-weight "${STAGE2_OOB_MID_HIGH_WEIGHT}"
