...
LOSS_KL_WEIGHT="${LOSS_KL_WEIGHT:-0.45}"
LOSS_PAIR_WEIGHT="${LOSS_PAIR_WEIGHT:-0.22}"
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.26}"
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-0.95}"
...
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-2.7}"
STAGE2_OOB_LOW_WEIGHT="${STAGE2_OOB_LOW_WEIGHT:-3.2}"
