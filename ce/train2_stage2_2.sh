...
# ==========================================================
# CE Stage2 continuation runner (train2.py) from a strong Stage2 checkpoint
# ==========================================================
# Usage:
#   bash ce/train2_stage2_2.sh
#
# Purpose:
#   Low-LR calibration polish from the current best gated Stage2 checkpoint.
#   Goal is to compress mid OOB while preserving low/high OOB and ranking.
...
STAGE2_EARLY_STOP_PATIENCE="${STAGE2_EARLY_STOP_PATIENCE:-4}"
...
STAGE2_LEARNING_RATE="${STAGE2_LEARNING_RATE:-1.2e-7}"
...
LOSS_KL_WEIGHT="${LOSS_KL_WEIGHT:-0.58}"
...
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-1.10}"
...
DOMAIN_LIST_LOSS_SCALE="${DOMAIN_LIST_LOSS_SCALE:-1.18}"
METHOD_LIST_LOSS_SCALE="${METHOD_LIST_LOSS_SCALE:-1.00}"
CONSTRAINT_LIST_LOSS_SCALE="${CONSTRAINT_LIST_LOSS_SCALE:-1.0}"
DOMAIN_CALIBRATION_HIGH_SCALE="${DOMAIN_CALIBRATION_HIGH_SCALE:-1.70}"
DOMAIN_CALIBRATION_MID_SCALE="${DOMAIN_CALIBRATION_MID_SCALE:-2.00}"
DOMAIN_CALIBRATION_LOW_SCALE="${DOMAIN_CALIBRATION_LOW_SCALE:-0.90}"
METHOD_CALIBRATION_HIGH_SCALE="${METHOD_CALIBRATION_HIGH_SCALE:-1.10}"
METHOD_CALIBRATION_MID_SCALE="${METHOD_CALIBRATION_MID_SCALE:-1.45}"
METHOD_CALIBRATION_LOW_SCALE="${METHOD_CALIBRATION_LOW_SCALE:-1.50}"
...
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.18}"
CALIB_LOW_CEIL="${CALIB_LOW_CEIL:-0.065}"
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.9}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-3.0}"
LOSS_CALIBRATION_LOW_WEIGHT="${LOSS_CALIBRATION_LOW_WEIGHT:-2.0}"
STAGE2_OOB_SELECTION_SPLIT="${STAGE2_OOB_SELECTION_SPLIT:-val}"  # val | test
STAGE2_OOB_HIGH_WEIGHT="${STAGE2_OOB_HIGH_WEIGHT:-3.2}"
STAGE2_OOB_MID_WEIGHT="${STAGE2_OOB_MID_WEIGHT:-5.8}"
...
WANDB_TAGS="${WANDB_TAGS:-ce,domain,method,stage2-continuation,mid-compress,constraint}"
...
EVAL_SAVE_PREFIX="${EVAL_SAVE_PREFIX:-ce_distill_margin_compare_stage2_continuation}"
