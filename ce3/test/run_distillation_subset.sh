...
PREFILTER_HIGH_PER_ASPECT="${PREFILTER_HIGH_PER_ASPECT:-1}"
PREFILTER_MID_PER_ASPECT="${PREFILTER_MID_PER_ASPECT:-1}"
PREFILTER_LOW_PER_ASPECT="${PREFILTER_LOW_PER_ASPECT:-1}"
