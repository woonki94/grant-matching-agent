...
ASPECT_DEFINITIONS = {
    "topic": (
        "main subject, problem area, technical context, field, discipline, "
        "application area, or service area"
    ),
    "approach": (
        "capability, method, technique, action, workflow, model, intervention, "
        "measurement, analysis procedure, design process, or work performed"
    ),
    "objective": (
        "target object, beneficiary, system, material, dataset, outcome, condition, "
        "use case, deployment setting, requirement, or intended purpose"
    ),
}
...
FEW_SHOT_EXAMPLES = """
Examples of controlled augmentation:

Example 1
Source:
experience managing consortium-based projects involving institutions of higher education, research institutes, and economic development entities

Source decomposition:
{
  "topic": ["consortium-based institutional collaboration"],
  "approach": ["managing consortium-based projects"],
  "objective": ["institutions of higher education", "research institutes", "economic development entities"]
}
...
Bad augmentation:
designing collaborative research frameworks across academic institutions, laboratories, and innovation hubs

Why bad:
It preserves near-equivalent objective entities and preserves an adjacent approach.

Better augmentation:
analyzing governance models for multi-organization collaborations among museums, libraries, and civic volunteer groups

Expected behavior:
topic high, approach low/mid, objective low


Example 2
Source:
relapse prevention strategies and recovery maintenance support through ongoing clinical and peer-based interventions

Source decomposition:
{
  "topic": ["relapse prevention", "recovery maintenance"],
  "approach": ["clinical interventions", "peer-based support"],
  "objective": ["substance use recovery", "sustained sobriety"]
}
...
Bad augmentation:
relapse prevention and recovery maintenance through digital health tools and community engagement programs

Why bad:
It preserves the topic, but also preserves the recovery-support objective too strongly.

Better augmentation:
analyzing policy language about relapse prevention and recovery maintenance in behavioral health reports

Expected behavior:
topic high, approach low, objective low/mid


Example 3
Source:
ambient-pressure X-ray photoelectron spectroscopy characterization of surface reactions

Source decomposition:
{
  "topic": ["surface reactions", "surface chemistry"],
  "approach": ["ambient-pressure X-ray photoelectron spectroscopy", "XPS characterization"],
  "objective": ["surface reactions", "ambient-pressure conditions"]
}
...
Better augmentation:
ambient-pressure X-ray photoelectron spectroscopy characterization of polymer coating degradation

Expected behavior:
approach high, topic low/mid, objective low
""".strip()
...
Use the following examples to understand the controlled augmentation goal:
{few_shot_examples}

Now generate augmentations for the actual source.
