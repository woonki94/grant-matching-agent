...
class GroupJustificationService:
    def __init__(
        self,
        *,
        session_factory=SessionLocal,
        context_generator: Optional[ContextGenerator] = None,
        team_grant_matcher: Optional[TeamGrantMatcherService] = None,
    ):
        self.session_factory = session_factory
        self.context_generator = context_generator or ContextGenerator()
        self.team_grant_matcher = team_grant_matcher or TeamGrantMatcherService(
