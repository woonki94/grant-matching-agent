...
from services.justification.generate_justification import print_faculty_recs
...
single_justification_generator = SingleJustificationGenerator()
...
def main() -> None:
    ...
    if results:
        try:
            out = single_justification_generator.generate_faculty_recs(email=email, k=10)
