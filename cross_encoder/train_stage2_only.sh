...
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.25}"
LISTWISE_SCORE_MODE="${LISTWISE_SCORE_MODE:-raw}"        # raw | normalized
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-1.35}"
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-1.00}"
...
CALIB_HIGH_FLOOR="${CALIB_HIGH_FLOOR:-0.85}"
CALIB_MID_CENTER="${CALIB_MID_CENTER:-0.36}"
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.06}"
