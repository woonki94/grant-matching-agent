...
LOSS_KL_WEIGHT="${LOSS_KL_WEIGHT:-0.55}"
...
LOSS_CLUSTER_MARGIN_WEIGHT="${LOSS_CLUSTER_MARGIN_WEIGHT:-1.30}"
LOSS_CALIBRATION_BAND_WEIGHT="${LOSS_CALIBRATION_BAND_WEIGHT:-1.10}"
CLUSTER_MARGIN_HM="${CLUSTER_MARGIN_HM:-0.27}"
CLUSTER_MARGIN_ML="${CLUSTER_MARGIN_ML:-0.28}"
CLUSTER_MARGIN_HL="${CLUSTER_MARGIN_HL:-0.58}"
CALIB_BAND_MODE="${CALIB_BAND_MODE:-fixed}"        # fixed | data_driven
CALIB_ANCHOR_STAT="${CALIB_ANCHOR_STAT:-mean}"           # mean | median
CALIB_HIGH_FLOOR="${CALIB_HIGH_FLOOR:-0.82}"
CALIB_MID_CENTER="${CALIB_MID_CENTER:-0.38}"
CALIB_MID_BANDWIDTH="${CALIB_MID_BANDWIDTH:-0.07}"
