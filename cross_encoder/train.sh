...
LOSS_MSE_WEIGHT="${LOSS_MSE_WEIGHT:-0.10}"
...
LOSS_CALIBRATION_HIGH_WEIGHT="${LOSS_CALIBRATION_HIGH_WEIGHT:-1.35}"
LOSS_CALIBRATION_MID_WEIGHT="${LOSS_CALIBRATION_MID_WEIGHT:-1.15}"
...
PAIR_MID_MIN_CANDIDATES="${PAIR_MID_MIN_CANDIDATES:-8}"
...
STAGE2_GATED_NDCG_MIN="${STAGE2_GATED_NDCG_MIN:-0.935}"
STAGE2_GATED_MRR_MIN="${STAGE2_GATED_MRR_MIN:-0.310}"
STAGE2_GATED_RECALL_MIN="${STAGE2_GATED_RECALL_MIN:-0.790}"
...
log "learning_rates base=${LEARNING_RATE} stage1=${STAGE1_LEARNING_RATE} stage2=${STAGE2_LEARNING_RATE}"
...
log "stage2_gated_selection=${STAGE2_GATED_SELECTION} metric=${STAGE2_GATED_RANKING_METRIC} floors ndcg/mrr/recall=${STAGE2_GATED_NDCG_MIN}/${STAGE2_GATED_MRR_MIN}/${STAGE2_GATED_RECALL_MIN}"
