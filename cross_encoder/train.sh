...
# Loss calibration knobs (balanced full-training defaults)
...
PAIR_MID_MARGIN_MIN="${PAIR_MID_MARGIN_MIN:-0.08}"
PAIR_MID_MARGIN_MAX="${PAIR_MID_MARGIN_MAX:-0.45}"
PAIR_MID_MIN_CANDIDATES="${PAIR_MID_MIN_CANDIDATES:-5}"
PAIR_MID_START_RATIO="${PAIR_MID_START_RATIO:-0.30}"
PAIR_MID_END_RATIO="${PAIR_MID_END_RATIO:-0.60}"
PAIR_LOWER_MID_START_RATIO="${PAIR_LOWER_MID_START_RATIO:-0.50}"
PAIR_LOWER_MID_END_RATIO="${PAIR_LOWER_MID_END_RATIO:-0.82}"
